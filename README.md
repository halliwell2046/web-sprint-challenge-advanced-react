...
a function does not have a state, where a stateful component uses state to render

2. When does a componentWillMount function be called? What about a componentWillUpdate?.
componentWillMount runs right before the component is removed from the DOM
componentWillUpdate runs once everything has rendered

3. Define stateful logic.
when you use state in your code

4. What are the three step of creating a successful test? What is done in each phase?
Arrange: setup the component that needs to be tested
Act: execute
Assert: make sure the desired result happened.
